...
class Messages {
	...
	*/
	...
	public static function addEntry(MessageEntry $entry) {
		...
		\Session::set('messages', static::$entries);
	}
	 ...
	 * @return \View[]
	 */
	public static function get($type="",$clear=null,$limit=null) {
		return static::getViews('html', $type, $clear, $limit);
	}
	 ...
	 * @return \View[]
	 */
	public static function get_json($type="",$clear=null,$limit=null) {
		return static::getViews('json', $type, $clear, $limit);
	}
	 ...
	 * @return \View[]
	 */
	public static function get_xml($type="",$clear=null,$limit=null) {
		return static::getViews('xml', $type, $clear, $limit);
	}
	...
	public static function _init() {
		...
		if (\Session::get('messages')) {
			static::$entries = \Session::get('messages');
	 ...
	 * @return \View[]
	 */
	protected static function getViews($template, $type="", $clear=null, $limit = null) {
		if ($limit == null) {
			$limit = 10;
		}
		if ($clear == null) {
